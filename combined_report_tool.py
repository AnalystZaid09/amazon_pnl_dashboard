...
st.sidebar.info("Upload the Excel/CSV result files generated by the individual tools.")
...
with st.sidebar.expander("📉 System Metrics (RLC, Reimb, Damage)"):
    ...
    inv_res = st.file_uploader("Inventory: inventory_brand_pivot.csv", type=["xlsx", "csv"])
...
def load_and_norm(f, prefix=None):
    ...
    try:
        ...
        if "Brand" in df.columns:
            ...
            if prefix:
                # Rename generic columns like 'total' or 'Support' to avoid collision
                for col in df.columns:
                    if col != "Brand" and str(col).lower() in ["total", "support", "p/l", "discount", "p&l", "cp as per qty"]:
...
col_rename = {
    ...
    "coupon discount": "Coupon Support", "coupon support": "Coupon Support", "coupon total": "Coupon Support",
    "total seller funding": "Exchange Support", "exchange funding": "Exchange Support", "exchange support": "Exchange Support",
    "freebies discount": "Freebies", "freebies": "Freebies", "freebies support": "Freebies",
    "total amount (incl. gst)": "Advertising Support", "advertising support": "Advertising Support", "ads support": "Advertising Support",
    "ncemi support": "NCEMI Support", "ncemi total": "NCEMI Support",
    "inbound total": "Inbound Pick Up Service", "inbound inbound pick up service": "Inbound Pick Up Service",
    "replacement total": "Replacement charges", "replacement charges": "Replacement charges",
    "dyson support": "Dyson Support", "dyson support as per net sale": "Dyson Support",
    "bergner support": "Bergner Sec Support", "bergner p/l on orders qty": "Bergner Sec Support", "bergner sec cn value": "Bergner Sec Support",
    "tramontina support": "Tramontina Sec Support", "tramontina sec support": "Tramontina Sec Support",
    ...
    "reimb fba total": "Reimbursement FBA", "reimb fba fba reimbursement": "Reimbursement FBA", "reimbursement fba": "Reimbursement FBA",
    "reimb seller total": "Reimbursement Seller Flex (Safe T Claim)", "reimbursement seller flex (safe t claim)": "Reimbursement Seller Flex (Safe T Claim)",
    ...
    "loss seller total": "Loss in damages Seller Flex", "loss in damages seller flex": "Loss in damages Seller Flex",
    "inventory total": "Current Inventory", "inventory cp inventory value": "Current Inventory", "current inventory": "Current Inventory",
    "storage total": "Storage Charges", "storage storage fee": "Storage Charges", "storage charges": "Storage Charges",
    "damage current damages": "Current damages", "damage cp as per qty": "Current damages", "current damages": "Current damages", "current cp as per qty": "Current damages"
}
